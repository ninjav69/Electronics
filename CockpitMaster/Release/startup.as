	...
	; --runtime=+clear --runtime=+clib --runtime=+keep -oCockpitMaster.hex \
	; uart.p1 sb.p1 rof.p1 main.p1 isr.p1 init.p1 fifo.p1 adc.p1
	;
...
;	11 bytes of RAM objects in bank 0 to zero
	...
	movwf	FSR
	movlw	low(__Lrbss_0+11)		;load the high address+1 into W

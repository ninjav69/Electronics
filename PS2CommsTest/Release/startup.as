	...
	; --runtime=+clear --runtime=+clib --runtime=+keep -oPS2CommsTest.hex \
	; ps2comms.p1 main.p1 isr.p1 init.p1 fifo.p1
	;
...
;	32 bytes of RAM objects in bank 0 to zero

	psect	init
	global	__Lrbss_0
	movlw	low(__Lrbss_0)		;load the low address into FSR
	movwf	FSR
	movlw	low(__Lrbss_0+32)		;load the high address+1 into W
